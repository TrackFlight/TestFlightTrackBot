...
var (
	RegexAppName = regexp.MustCompile(
		`<title>(?:Join the |加入 Beta 版“|Присоединяйтесь к тестированию бета-версии приложения «|Nimm an der |Accéder à la version bêta de )([^<]+?)(?: beta|”|»|-Beta teil\.|) - TestFlight - Apple</title>`,
	)
